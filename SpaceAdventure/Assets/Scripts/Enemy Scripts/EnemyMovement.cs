...
public class EnemyMovement : MonoBehaviour
{
    ...
    [SerializeField] private float horizontal_MovementTreshold = 8f;
    [SerializeField] private float vertical_MovementTreshold = 6f;
        ...
        void HandleEnemyMovement_Vertical()
    {
        ...
        if(moveUp)
        {
            ...
            if(tempMovement_Horizontal.y > max_Y)
                moveUp = false;
        }
        else
        {
